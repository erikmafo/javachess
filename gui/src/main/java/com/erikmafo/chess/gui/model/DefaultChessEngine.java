 ...
 */
public class DefaultChessEngine implements ChessEngine {

    private Board board;
    private final FenParser fenParser;
    private final ExecutorService executorService;

    public DefaultChessEngine(FenParser fenParser, ExecutorService executorService) {
        ...
        Task<EngineSearchResult> resultTask = new Task<EngineSearchResult>() {
            ...
            protected EngineSearchResult call() throws Exception {
                ...
                try {
                    ...
                    Logger.getLogger(DefaultChessEngine.class.getName()).log(Level.SEVERE, null, ex);
                    throw ex;
                }
